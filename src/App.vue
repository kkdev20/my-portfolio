<template>
  <div id="app">
    ...
    <main class="main">
          ...
          >
            <a :href="project.liveUrl" target="_blank" rel="noopener noreferrer" class="project-link">
              <div class="project-header">
                ...
                <span :class="['status-indicator', project.status === 'development' ? 'dev-indicator' : 'live-indicator']">
                  <span :class="project.status === 'development' ? 'dev-dot' : 'live-dot'"></span>
                  {{ project.status === 'development' ? 'Development' : 'Live' }}
                </span>
              </div>
      ...
      <!-- Watermark -->
      <div class="watermark">
        <a href="https://wistack.site" target="_blank" rel="noopener noreferrer">wistack.site</a>
      </div>
    </main>
